# SocialiteForJinshuju
A PHP laravel framework for Jinshuju based on Socialite
...
You will also need to add credentials for the OAuth services your application utilizes. These credentials should be placed in your `config/services.php` configuration file, and should use the key `jinshuju`, depending on the providers your application requires. For example:
```php
'github' => [
...
{
/**
* Redirect the user to the Jinshuju authentication page.
*
* @return Response
*/
public function redirectToProvider()
{
return Socialite::driver('jinshuju')->redirect();
}

/**
* Obtain the user information from Jinshuju.
*
* @return Response
*/
public function handleProviderCallback()
{
$user = Socialite::driver('jinshuju')->user();
...
```php
return Socialite::driver('jinshuju')
...
```php
Route::get('auth/jinshuju', 'Auth\AuthController@redirectToProvider');
Route::get('auth/jinshuju/callback', 'Auth\AuthController@handleProviderCallback');
```
